...
ci_sd <- function(y, alpha = 0.05) {
  ...
  scr_sd <- sqrt(m-1) * sd_hat_2 # chi critical values (here we use that they may be computed from the chi-squared critical values, which are available in R, by taking a square root)
